      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 max-h-[90vh] overflow-y-auto">
          ...
          {isNewCustomer && (
            <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-3 space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setNewCustomer({ ...newCustomer, no_hp: e.target.value })
                }
              />
        ...
        <div className="mb-3">
          ...
          <input
            ...
            value={nominalBayar ? `Rp ${parseInt(bayar.replace(/\D/g, ''), 10).toLocaleString('id-ID')}` : ''}
        ...
        <div className="flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 py-3 border rounded-xl hover:bg-gray-50 font-medium"
          >
            Batal
          </button>
